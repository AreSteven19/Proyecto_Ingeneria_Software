...
export const createFactura = async (req, res) => {
    ...
    try {
        const { client_id_name, client_id_barber, services, date, time, price, total } = req.body;
        await pool.query(" insert into factura (client_id_name, client_id_barber, services, date, time, price, total) values (?,?,?,?,?,?,?)",
            [client_id_name, client_id_barber, services, date, time, price, total]);
